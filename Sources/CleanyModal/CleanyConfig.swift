...
public extension CleanyAlertConfig {
    ...
    static func getDefaultStyleSettings() -> StyleSettings {
        ...
        styleSettings.set(key: .mainViewMaskedBounds, value: [.layerMinXMinYCorner, .layerMaxXMinYCorner, .layerMinXMaxYCorner, .layerMaxXMaxYCorner])
        styleSettings.set(key: .cancelViewMaskedBounds, value: [.layerMinXMinYCorner, .layerMaxXMinYCorner, .layerMinXMaxYCorner, .layerMaxXMaxYCorner])
...
public extension CleanyAlertConfig.StyleKeys {
    ...
    static let mainViewMaskedBounds = CleanyAlertConfig.StyleKey<CACornerMask>("mainViewMaskedBounds")
    static let cancelViewMaskedBounds = CleanyAlertConfig.StyleKey<CACornerMask>("cancelViewMaskedBounds")
